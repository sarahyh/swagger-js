...
"use strict";var _={cloneDeep:require("lodash-compat/lang/cloneDeep"),forEach:require("lodash-compat/collection/forEach"),indexOf:require("lodash-compat/array/indexOf"),isArray:require("lodash-compat/lang/isArray"),isPlainObject:require("lodash-compat/lang/isPlainObject"),isString:require("lodash-compat/lang/isString"),isUndefined:require("lodash-compat/lang/isUndefined"),keys:require("lodash-compat/object/keys"),map:require("lodash-compat/collection/map")},helpers=require("../helpers"),Model=module.exports=function(e,i,t,n){return this.definition=i||{},this.isArray="array"===i.type,this.models=t||{},this.name=i.title||e||"Inline Model",this.modelPropertyMacro=n||function(e){return e["default"]},this},schemaToHTML=function(e,i,t,n){var s={},r=[],o=0,a=function(e,i,r){var a,p=i;return e.$ref?(p=e.title||helpers.simpleRef(e.$ref),a=t[p],null!==a&&null!==a.definition.title&&"undefined"!=typeof a.definition.title&&(p=a.definition.title)):_.isUndefined(i)&&(p=e.title||"Inline Model "+ ++o,a=new Model(p,e,t,n)),r!==!0&&(s[p]=_.isUndefined(a)?{}:a.definition),p},p=function(e){var i,t='<span class="propType"',n=e.type||"object";return e.$ref?(i=a(e,helpers.simpleRef(e.$ref)),t+=" title="+i+">"+i):"object"===n?_.isUndefined(e.properties)?t+=' title="object">object':(i=a(e),t+=" title="+i+">"+i):"array"===n?(_.isArray(e.items)?i=_.map(e.items,a).join(","):_.isPlainObject(e.items)?i=_.isUndefined(e.items.$ref)?_.isUndefined(e.items.type)||-1!==_.indexOf(["array","object"],e.items.type)?a(e.items):e.items.type:a(e.items,helpers.simpleRef(e.items.$ref)):(helpers.log("Array type's 'items' schema is not an array or an object, cannot process"),i="object"),t+=" title=array["+i+"]>array["+i+"]"):t+=" title="+e.type+">"+e.type,t+="</span>"},l=function(e,i){var t="",n=e.type||"object",s="array"===n;switch(s&&(n=_.isPlainObject(e.items)&&!_.isUndefined(e.items.type)?e.items.type:"object"),_.isUndefined(e["default"])||(t+=helpers.optionHtml("Default",e["default"])),n){case"string":e.minLength&&(t+=helpers.optionHtml("Min. Length",e.minLength)),e.maxLength&&(t+=helpers.optionHtml("Max. Length",e.maxLength)),e.pattern&&(t+=helpers.optionHtml("Reg. Exp.",e.pattern));break;case"integer":case"number":e.minimum&&(t+=helpers.optionHtml("Min. Value",e.minimum)),e.exclusiveMinimum&&(t+=helpers.optionHtml("Exclusive Min.","true")),e.maximum&&(t+=helpers.optionHtml("Max. Value",e.maximum)),e.exclusiveMaximum&&(t+=helpers.optionHtml("Exclusive Max.","true")),e.multipleOf&&(t+=helpers.optionHtml("Multiple Of",e.multipleOf))}if(s&&(e.minItems&&(t+=helpers.optionHtml("Min. Items",e.minItems)),e.maxItems&&(t+=helpers.optionHtml("Max. Items",e.maxItems)),e.uniqueItems&&(t+=helpers.optionHtml("Unique Items","true")),e.collectionFormat&&(t+=helpers.optionHtml("Coll. Format",e.collectionFormat))),_.isUndefined(e.items)&&_.isArray(e["enum"])){var r;r="number"===n||"integer"===n?e["enum"].join(", "):'"'+e["enum"].join('", "')+'"',t+=helpers.optionHtml("Enum",r)}return"string"==i&&(i=m(n,e.description)),i},m=function(e,i){return'<span class="propLabels"><span class="propType" title="'+e+'">'+e+'</span></span><span class="propDesc">'+i+"</span>"},c=function(e,i){var s=e.type||"object",o="array"===e.type,c='<span class="strong objectName"><span class="bracketsIcon">'+(o?"[]":"{}")+'</span> <span class="objectNameText">',d="</span></span>",f="";if("Inline Model"!==i&&(f=_.isUndefined(e.title)?c+i+d:c+e.title+d),i&&r.push(i),o)if(_.isArray(e.items))f+="<div>"+_.map(e.items,function(e){var i=e.type||"object";return _.isUndefined(e.$ref)?_.indexOf(["array","object"],i)>-1?"object"===i&&_.isUndefined(e.properties)?"object":a(e):l(e,i):a(e,helpers.simpleRef(e.$ref))}).join("</div><div>");else if(_.isPlainObject(e.items)){var h="";if(h=_.isUndefined(e.items.$ref)?_.indexOf(["array","object"],e.items.type||"object")>-1?(_.isUndefined(e.items.type)||"object"===e.items.type)&&_.isUndefined(e.items.properties)?"object":a(e.items):l(e.items,e.items.type):a(e.items,helpers.simpleRef(e.items.$ref)),"Inline Model"!==i){var u="array["+h+"]";f+="<div>"+m(u,e.description)+"</div>"}}else helpers.log("Array type's 'items' property is not an array or an object, cannot process"),f+="<div>object</div>";else e.$ref?f+="<div>"+a(e,i)+"</div>":"object"===s?(f+="<div>",_.isPlainObject(e.properties)&&(f+=_.map(e.properties,function(i,s){var r,o=_.indexOf(e.required,s)>=0,a=_.cloneDeep(i),m='<span class="propLabels">';return m+='<span class="propName propOpt">'+s+"</span>",a["default"]=n(a),a=helpers.resolveSchema(a),_.isUndefined(a.$ref)||(r=t[helpers.simpleRef(a.$ref)],_.isUndefined(r)||-1!==_.indexOf([void 0,"array","object"],r.definition.type)||(a=helpers.resolveSchema(r.definition))),m+=p(a),o||(m+='<span class="propOptKey">(optional)</span>'),m+="</span>",m+='<span class="propDesc">',_.isUndefined(i.description)||(m+=i.description),a["enum"]&&(m+='<div class="propVals">Can be ',_.forEach(a["enum"],function(e,i){m+="<code>"+e+"</code>",i===a["enum"].length-2?m+=" or ":i<a["enum"].length-1&&(m+=", ")}),m+="</div>"),m+="</span>",l(a,m)}).join("</div><div>")),f+="</div>"):f+="<div>"+l(e,s)+"</div>";return f};i=helpers.resolveSchema(i);var d=c(i,e);for(console.log("processModel returned "+e+" schema: "+i+" html: "+d);_.keys(s).length>0;)_.forEach(s,function(e,i){var t=_.indexOf(r,i)>-1;delete s[i],t||(r.push(i),d+=c(e,i))});return d},schemaToJSON=function(e,i,t,n){e=helpers.resolveSchema(e);var s,r,o=e.type||"object",a=e.format;return e.example?r=e.example:_.isUndefined(e.items)&&_.isArray(e["enum"])&&(r=e["enum"][0]),_.isUndefined(r)&&(e.$ref?(s=i[helpers.simpleRef(e.$ref)],_.isUndefined(s)||(_.isUndefined(t[s.name])?(t[s.name]=s,r=schemaToJSON(s.definition,i,t,n),delete t[s.name]):r="array"===s.type?[]:{})):_.isUndefined(e["default"])?"string"===o?r="date-time"===a?(new Date).toISOString():"date"===a?(new Date).toISOString().split("T")[0]:"string":"integer"===o?r=0:"number"===o?r=0:"boolean"===o?r=!0:"object"===o?(r={},_.forEach(e.properties,function(e,s){var o=_.cloneDeep(e);o["default"]=n(e),r[s]=schemaToJSON(o,i,t,n)})):"array"===o&&(r=[],_.isArray(e.items)?_.forEach(e.items,function(e){r.push(schemaToJSON(e,i,t,n))}):_.isPlainObject(e.items)?r.push(schemaToJSON(e.items,i,t,n)):_.isUndefined(e.items)?r.push({}):helpers.log("Array type's 'items' property is not an array or an object, cannot process")):r=e["default"]),r};Model.prototype.createJSONSample=Model.prototype.getSampleValue=function(e){return e=e||{},e[this.name]=this,this.examples&&_.isPlainObject(this.examples)&&this.examples["application/json"]?(this.definition.example=this.examples["application/json"],_.isString(this.definition.example)&&(this.definition.example=JSON.parse(this.definition.example))):this.definition.example||(this.definition.example=this.examples),schemaToJSON(this.definition,this.models,e,this.modelPropertyMacro)},Model.prototype.getMockSignature=function(){var e=schemaToHTML(this.name,this.definition,this.models,this.modelPropertyMacro);return console.log(this.definition),console.log(this.name+" getMockSignature: "+e),e};
